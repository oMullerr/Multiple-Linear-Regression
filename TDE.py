...
print("Passo 1: ")
print()
# criei uma lista para armazenar todas as variáveis presentes no meu banco de dados
variaveisIndependentes = []
for i in base: # for para percorrer toda a base de dados
  if i not in variaveisIndependentes: # se a variável nao estiver na lista
    variaveisIndependentes.append(i) # adicionamos ela na lista
  else: 
    break

print("As variáveis que estão presentes na base de dados são: \n", variaveisIndependentes) # print com todas as variaveis do nosso banco de dados ja na lista
print()
print("Cada uma dessas variáveis indica as skills de cada programador, ou seja, indica quanto o programador conhece a linguagem.")
...
for linguagem in base: # for para percorrer toda a base de dados
...
print("As duas variáveis com maior correlação no meu banco de dados são: \n")
print('Linguagem C \nLinguagem C#')
print()
...
print("Para obter a Regressão Linear Múltipla, devemos definir as nossas variáveis dependentes e independentes. No meu caso o X é a minha variável independente \né o Y é a minha variável dependente.")
print()
print("Entao fica assim: ")
print()
print("x = base[['c', 'c#']] \ny = base['python']")
print()
print("Logo depois definimos a variável 'regrecao' e chamamos a função da regreção linear")
